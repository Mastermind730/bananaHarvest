      ...
      <div className="row">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav flex-column w-100 p-4">
                <li className="nav-item">
                  <Link to="/farmerBill" className="nav-link custom-link">
                    Farmer Bill
                  </Link>
                </li>
                <li className="nav-item">
                  <Link to="/CompanyBill" className="nav-link custom-link">
                    Company Bill
                  </Link>
                </li>
                <li className="nav-item">
                  <button className="btn btn-link nav-link custom-link">
                    Labor Bill
                  </button>
                </li>
                <li className="nav-item">
        ...
        <div className="col-12 col-md-10 bg-gray-100 p-4">
          <img
            src="/bg.jpg"
            alt="Harvest_image"
            className="img-fluid harvest_image"
          />
        </div>
      </div>
    </div>
